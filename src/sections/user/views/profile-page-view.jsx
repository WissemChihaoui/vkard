...
import { socialFb, socialGoogle, socialLinkedin, socialX } from "../../../assets";
  ...
  return (
    <div className="wrapper">
      ...
      <div className="profile">
        <div className="coverShit">
          <img className="imageCover" src="https://images.unsplash.com/photo-1531297484001-80022131f5a1?q=80&w=1640&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
          <img
      ...
      <h3 className="text-center text-lg mt-4">Let's connect</h3>
      ...
      <div className="w-full flex flex-col items-center mt-12 gap-6">
