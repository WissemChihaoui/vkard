...
import { loginBtn, speedgiWhiteLogo } from "../../assets";
  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <Link to={paths.root} className="block w-[12rem] xl:mr-8" href="#hero">
          <img src={speedgiWhiteLogo} width={180} height={40} alt="Speedgi" />
        </Link>
